CLASS zcl_360_carga_biblio_4194 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_360_carga_biblio_4194 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_cat_4194,
          lt_catego    TYPE TABLE OF ztb_catego_4194,
          lt_clientes  TYPE TABLE OF ztb_cliente_4194,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_l_4194,
          lt_libros    TYPE TABLE OF ztb_libros_4194.
...
******** ztb_acc_cat_4194 ********
    ...
    DELETE FROM ztb_acc_cat_4194.
    INSERT ztb_acc_cat_4194 FROM TABLE @lt_acc_categ.
...
******** ztb_catego_4194 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_4194.
    INSERT ztb_catego_4194 FROM TABLE @lt_catego.
...
******** ztb_cliente_4194 ********
    "fill internal table
    lt_clientes = VALUE #(
    ( id_client = '005638984K' tipo_acceso = '1' nombre = 'Andrew' apellidos = 'Roberts' email = 'STEPHANIE.ROBERTS@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_client = '049320909Q' tipo_acceso = '2' nombre = 'Natalie' apellidos = 'Clark' email = 'PETER.CLARK@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '049573865T' tipo_acceso = '1' nombre = 'Faith' apellidos = 'Black' email = 'DAN.BLACK@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_client = '203947278B' tipo_acceso = '3' nombre = 'Carolyn' apellidos = 'Wright' email = 'ADRIAN.WRIGHT@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '234234231T' tipo_acceso = '5' nombre = 'Penelope' apellidos = 'King' email = 'CAROLINE.KING@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '239482309W' tipo_acceso = '5' nombre = 'Julian' apellidos = 'Underwood' email = 'DAN.UNDERWOOD@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_client = '276594867J' tipo_acceso = '5' nombre = 'Olivia' apellidos = 'Allan' email = 'OWEN.ALLAN@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '283748858A' tipo_acceso = '5' nombre = 'Eric' apellidos = 'Knox' email = 'LILY.KNOX@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_client = '324726345S' tipo_acceso = '4' nombre = 'Vanessa' apellidos = 'Baker' email = 'SUE.BAKER@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '340958439D' tipo_acceso = '5' nombre = 'Michael' apellidos = 'Short' email = 'JASON.SHORT@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '345093450E' tipo_acceso = '3' nombre = 'Sue' apellidos = 'Sanderson' email = 'JOAN.SANDERSON@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '345838534R' tipo_acceso = '5' nombre = 'Lily' apellidos = 'Langdon' email = 'ANDREW.LANGDON@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '348947597P' tipo_acceso = '5' nombre = 'Lillian' apellidos = 'Davies' email = 'JULIAN.DAVIES@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '378458844M' tipo_acceso = '5' nombre = 'Joseph' apellidos = 'Smith' email = 'NATALIE.SMITH@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_client = '423586845G' tipo_acceso = '5' nombre = 'Stephanie' apellidos = 'Quinn' email = 'LILLIAN.QUINN@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '430958433A' tipo_acceso = '2' nombre = 'Joan' apellidos = 'Short' email = 'WENDY.SHORT@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' )
    ( id_client = '439853453C' tipo_acceso = '5' nombre = 'Wendy' apellidos = 'Newman' email = 'JOSEPH.NEWMAN@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '453532543O' tipo_acceso = '1' nombre = 'Neil' apellidos = 'Wilson' email = 'VANESSA.WILSON@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '489632882D' tipo_acceso = '5' nombre = 'Sonia' apellidos = 'Welch' email = 'NEIL.WELCH@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/12/41.png' )
    ( id_client = '540867547H' tipo_acceso = '5' nombre = 'Adrian' apellidos = 'Young' email = 'PENELOPE.YOUNG@EMAIL.COM' url = 'https://d4.logaligroup.com/wp-content/uploads/2019/11/24.2.png' ) ).

    "Delete possible entries; insert new entries
    DELETE FROM ztb_cliente_4194.
    INSERT ztb_cliente_4194 FROM TABLE @lt_clientes.
...
******** ztb_clnts_l_4194
    lt_clnts_lib = VALUE #(
    ( id_client = '005638984K' id_libro = '000001' )
    ( id_client = '005638984K' id_libro = '000020' )
    ( id_client = '005638984K' id_libro = '000021' )
    ( id_client = '049320909Q' id_libro = '000002' )
    ( id_client = '049573865T' id_libro = '000003' )
    ( id_client = '203947278B' id_libro = '000004' )
    ( id_client = '234234231T' id_libro = '000005' )
    ( id_client = '239482309W' id_libro = '000006' )
    ( id_client = '239482309W' id_libro = '000010' )
    ( id_client = '276594867J' id_libro = '000007' )
    ( id_client = '276594867J' id_libro = '000001' )
    ( id_client = '283748858A' id_libro = '000008' )
    ( id_client = '283748858A' id_libro = '000022' )
    ( id_client = '324726345S' id_libro = '000009' )
    ( id_client = '340958439D' id_libro = '000010' )
    ( id_client = '345093450E' id_libro = '000011' )
    ( id_client = '345838534R' id_libro = '000012' )
    ( id_client = '345838534R' id_libro = '000003' )
    ( id_client = '348947597P' id_libro = '000013' )
    ( id_client = '348947597P' id_libro = '000022' )
    ( id_client = '378458844M' id_libro = '000014' )
    ( id_client = '423586845G' id_libro = '000015' )
    ( id_client = '430958433A' id_libro = '000016' )
    ( id_client = '439853453C' id_libro = '000017' )
    ( id_client = '439853453C' id_libro = '000022' )
    ( id_client = '439853453C' id_libro = '000001' )
    ( id_client = '453532543O' id_libro = '000018' )
    ( id_client = '453532543O' id_libro = '000022' )
    ( id_client = '489632882D' id_libro = '000019' )
    ( id_client = '540867547H' id_libro = '000020' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clnts_l_4194.
    INSERT ztb_clnts_l_4194 FROM TABLE @lt_clnts_lib.
...
******** ztb_libros_4194 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_4194.
    INSERT ztb_libros_4194 FROM TABLE @lt_libros.
